...
export default function FieldGoal3(props) {
  ...
  useEffect(() => {
    const fetchPlayerData = async () => {
      try {
        // Fetch player data from API for the 2023 season
        const response = await fetch(`https://nba-stats-db.herokuapp.com/api/playerdata/season/2023/?format=json`);
