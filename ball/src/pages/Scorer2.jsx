...
export default function Scorer2(props) {
  ...
  return (
    <div className="scorer2"> 
      ...
      <p>
        In the NBA 2023 playoffs, Nikola Jokic showcased his scoring prowess, outshining competitors like Jimmy Butler and 
        ...
        elevating his team's chances for success.
      </p>
    </div>
  );
}