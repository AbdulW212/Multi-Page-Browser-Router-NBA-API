...
export default function Scorer3(props) {
  ...
  return (
    <div className="scorer3">
      ...
      <p>In the NBA landscape, Jalen Brunson, Tyrese Maxey, and Scottie Barnes are emerging as rising stars worth keeping a keen 
        ...
        As they continue to develop and refine their game, they are poised to become key figures in the NBA's next generation of stars.</p>
    </div>
  );
}